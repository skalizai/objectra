  ...
  return (
    <div>
      ...
      <div className="scroll-x-top overflow-x-auto rounded-card border border-border">
        <table className="w-full min-w-[1470px] border-collapse text-sm">
          <thead>
            <tr className="border-b border-border bg-surface-2 text-left text-xs text-text-3">
              ...
              <th className="min-w-[130px] px-4 py-2.5 font-medium">Business unit</th>
          ...
          <tbody>
            {filtered.map((obj, i) => (
              ...
              >
                ...
                <td className="whitespace-nowrap px-4 py-2.5 font-mono text-xs text-text-2">{obj.business_unit || "—"}</td>
